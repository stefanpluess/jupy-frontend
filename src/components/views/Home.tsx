...
function DynamicGrouping() {
  ...
  async function createSession() {
    ...
    const token = "6ab2443ff085f5865317eee920d2d7c7c9241aa380e13694";
  ...
  const onDrop = async (event: DragEvent) => {
    ...
    if (wrapperRef.current) {
      ...
      let position = project({
        ...
        y: event.clientY - wrapperBounds.top - 120,
      });
      const nodeStyle =
        type === "group" ? { width: 800, height: 500 } : undefined;
      ...
      if (type === "group") {
        ...
        setWebSocketMap((prevMap) => ({
          ...prevMap,
          [newNode?.id]: newWebSocket,
        }));
      } else {
        newNode.data = {
          ...newNode.data,
